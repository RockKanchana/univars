...
export class GptBackdropComponent {
  ...
  programDurations: keyValue[] = [
    { value: 'less-6mo', viewValue: 'less than 6 months' },
    { value: '6mo-1yr', viewValue: '6 months - 1 year' },
    { value: '1yr-2yrs', viewValue: '1 year - 2 years' },
    { value: '3yrs', viewValue: '3 years' },
    { value: '4yrs', viewValue: '4 years' },
    { value: 'over-4yrs', viewValue: 'over 4 years' }
  ];

  programBudgets: keyValue[] = [
